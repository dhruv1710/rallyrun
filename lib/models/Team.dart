...
class Team extends Model {
  ...
  const Team._internal({required this.id, Players, createdAt, updatedAt}): _Players = Players, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Team({String? id, List<Player>? Players}) {
  ...
  Team copyWith({List<Player>? Players}) {
    return Team._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'Players': _Players?.map((Player? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'Players': _Players, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
